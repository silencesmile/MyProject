...
- (instancetype) init
{
    self = [super init];
    if (self) {
        self.backgroundColor = [UIColor clearColor]; // 背景底色
//        [self drawBgPentagon];
    }
    return  self;
}
...
- (CAShapeLayer *)shapeLayer
{
    if (!_shapeLayer) {
        ...
        _shapeLayer.fillColor = [UIColor  colorWithHex:0xfa8642 alpha:0.5].CGColor; // 目标颜色
    }
    return _shapeLayer;
}
...
- (void)drawBgPentagon:(NSArray *)array
{
